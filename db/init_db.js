...
<<<<<<< HEAD
        { name: 'Contemporary1', category: 'Contemporary', artist: 'Unknown', description: 'A Contemporary Artpiece.', price: '$675', rating: '10' },
        { name: 'Contemporary2', category: 'Contemporary', artist: 'Unknown', description: 'A Contemporary Artpiece.', price: '$649', rating: '6' },
        { name: 'Contemporary3', category: 'Contemporary', artist: 'Unknown', description: 'A Contemporary Artpiece.', price: '$659', rating: '8' },
        { name: 'Contemporary4', category: 'Contemporary', artist: 'Unknown', description: 'A Contemporary Artpiece.', price: '$685', rating: '5' },
        { name: 'Contemporary5', category: 'Contemporary', artist: 'Unknown', description: 'A Contemporary Artpiece.', price: '$166', rating: '9' },
        { name: 'Contemporary6', category: 'Contemporary', artist: 'Unknown', description: 'A Contemporary Artpiece.', price: '$399', rating: '7' },
        { name: 'FemmeDansUnFauteuil', category: 'Cubism', artist: 'Unknown', description: '1943 Original Picasso Lithograph.', price: '$1025', rating: '10' },
        { name: 'Weeping Woman', category: 'Cubism', artist: 'Picasso', description: 'Old Master Signed Picasso 1962', price: '$2542', rating: '10' },
        { name: 'Figure of a Woman', category: 'Cubism', artist: 'Juan Gris', description: 'Juan Gris.', price: '$132', rating: '8' },
        { name: 'Three Women', category: 'Cubism', artist: 'Fernand Leger', description: 'FernandLeger', price: '$108', rating: '6' },
        { name: 'The Knife Grinder', category: 'Cubism', artist: 'KazimirSeverinovichMalevich', description: 'KazimirSeverinovichMalevich', price: '$101', rating: '10' },
        { name: 'Symphony', category: 'Cubism', artist: 'Micahel Menkov', description: 'Michail Menkov', price: '$101', rating: '9' },
        { name: 'The Confetti Garden', category: 'Impressionism', artist: 'Jinlu', description: 'Jinlu', price: '$1976', rating: '8' },
        { name: 'Impressionist Lake Scene', category: 'Impressionism', artist: 'John Clymer', description: 'John Clymer', price: '$975', rating: '10' },
        { name: 'Impressionist French Landscape', category: 'Impressionism', artist: 'Unknown', description: 'Unknown', price: '$750', rating: '7' },
        { name: 'Spring in Central Park', category: 'Impressionism', artist: 'Natasha Kramskaya', description: 'Natasha Kramskaya', price: '$725', rating: '10' },
        { name: 'Signed Original Street Scene Paris', category: 'Impressionism', artist: 'Unknown', description: 'Unknown', price: '$695', rating: '9' },
        { name: 'Floral Landscape Flower Fields IV', category: 'Impressionism', artist: 'Michael Budden', description: 'Michael Budden', price: '$600', rating: '10' },
        { name: 'Cash Owns Everything Around Me', category: 'Popart', artist: 'ResatioAdiPutra', description: 'ResatioAdiPutra', price: '$250', rating: '10' },
        { name: 'Massive Stars Collapse III', category: 'Popart', artist: 'ResatioAdiPutra', description: 'ResatioAdiPutra', price: '$58', rating: '8' },
        { name: 'PissOff', category: 'Popart', artist: 'JirapatTatsanasomboon', description: 'JirapatTatsanasomboon', price: '$13000', rating: '10' },
        { name: 'DesireIngrained', category: 'Popart', artist: 'JirapatTatsanasomboon', description: 'JirapatTatsanasomboon', price: '$13000', rating: '9' },
        { name: 'SilaturahmiGorillaGlass', category: 'Popart', artist: 'HendraHeheHarsono', description: 'HendraHeheHarsono', price: '$3000', rating: '7' },
        { name: 'CapitalNoise', category: 'Popart', artist: 'HendraHeheHarsono', description: 'HendraHeheHarsono', price: '$5000', rating: '10' },
        { name: 'The River Seine', category: 'PostImpressionalism', artist: 'Adolph Clary Baroux', description: 'Adolph Clary Baroux', price: '$28500', rating: '9' },
        { name: 'Ballerinas Paris Opera', category: 'PostImpressionalism', artist: 'Jean Louis Marcel Cosson', description: 'Jean Louis Marcel Cosson', price: '$13605', rating: '10' },
        { name: 'Early Morning Hyde Park London', category: 'PostImpressionalism', artist: 'Elliott Seabrooke', description: 'Elliott Seabrooke', price: '$7396', rating: '7' },
        { name: 'Cafe Porto Fino Italy', category: 'PostImpressionalism', artist: 'Forrest Hewit', description: 'Forrest Hewit', price: '$5973', rating: '10' },
        { name: 'Village in Mexico', category: 'PostImpressionalism', artist: 'JacquesZucker', description: 'JacquesZucker', price: '$5250', rating: '9' },
        { name: 'Rural Farm Scene', category: 'PostImpressionalism', artist: 'Ludvig Jaconbsen', description: 'Ludvig Jaconbsen', price: '$4800', rating: '10' },
...
>>>>>>> c32a397ebd92305dc27bb45a38035cae3077452a
      ]
